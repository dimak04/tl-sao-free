...
class ShowAll extends React.Component {
  ...
  render() {
    const { typeOfOrganizations, searchItem, baseUrl, actions } = this.props;
    const { search, deleteTypeOfOrganization } = actions;
    ...
    return (
      <Table
        ...
        dataSource={typeOfOrganizations}
        size="small"
        bordered
            ...
            typeOfOrganizations.length >= 1 ? (
              <span>
                ...
                <Popconfirm
                  ...
                  onConfirm={() => deleteTypeOfOrganization(record.id)}
                >
                  <Icon
                    type="delete"
                    theme={"twoTone"}
