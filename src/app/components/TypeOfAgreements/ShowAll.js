...
class ShowAll extends React.Component {
  ...
  render() {
    const { typeOfAgreements, searchItem, baseUrl, actions } = this.props;
    const { search, deleteTypeOfAgreement } = actions;
            ...
            typeOfAgreements.length >= 1 ? (
              <span>
                ...
                <Popconfirm
                  ...
                  onConfirm={() => deleteTypeOfAgreement(record.id)}
                >
                  <Icon
                    type="delete"
                    theme={"twoTone"}
