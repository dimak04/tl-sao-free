...
export default function(state = initialState, action) {
  switch (action.type) {
    case types.FETCH_TYPE_OF_DELIVERIES_REQUEST:
      return _.assign({}, state, { isFetching: true, error: false });
    case types.FETCH_TYPE_OF_DELIVERIES_ERROR:
      return _.assign({}, state, { isFetching: false, error: true });
    case types.FETCH_TYPE_OF_DELIVERIES_SUCCESS:
    ...
    case types.CREATE_TYPE_OF_DELIVERY_REQUEST:
      return _.assign({}, state, {
        isCreating: true,
        error: false,
        errorMessage: ""
      });
    case types.CREATE_TYPE_OF_DELIVERY_ERROR:
      return _.assign({}, state, {
        isCreating: false,
        error: true,
        errorMessage: action.error.response
      });
    case types.CREATE_TYPE_OF_DELIVERY_SUCCESS:
      return _.assign({}, state, {
        entries: state.entries.concat(action.response.body.data),
        isCreating: false
      });

    case types.DELETE_TYPE_OF_DELIVERY_REQUEST:
      return _.assign({}, state, { isDeleting: true, error: false });
    case types.DELETE_TYPE_OF_DELIVERY_ERROR:
      return _.assign({}, state, { isDeleting: false, error: true });
    case types.DELETE_TYPE_OF_DELIVERY_SUCCESS:
    ...
    case types.UPDATE_TYPE_OF_DELIVERY_REQUEST:
      return _.assign({}, state, { isUpdating: true, error: false });
    case types.UPDATE_TYPE_OF_DELIVERY_ERROR:
      return _.assign({}, state, { isUpdating: false, error: true });
    case types.UPDATE_TYPE_OF_DELIVERY_SUCCESS:
      return _.assign({}, state, {
    ...
    case types.FETCH_TYPE_OF_DELIVERY_REQUEST:
      return _.assign({}, state, { isFetching: true, error: false });
    case types.FETCH_TYPE_OF_DELIVERY_ERROR:
      return _.assign({}, state, { isFetching: false, error: true });
    case types.FETCH_TYPE_OF_DELIVERY_SUCCESS:
      return _.assign({}, state, {
        entry: action.response.body.data,
        isFetching: false
      });

    case types.EDIT_TYPE_OF_DELIVERY:
      return _.assign({}, state, {
        entry: _.assign({}, state.entry, { [action.valueType]: action.value })
      });
    case types.RESET_TYPE_OF_DELIVERY_FORM:
      return _.assign({}, state, {
        entry: emptyEntry
      });

    case types.SEARCH_TYPE_OF_DELIVERIES:
      return _.assign({}, state, {
