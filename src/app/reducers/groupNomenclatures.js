...
export default function(state = initialState, action) {
  switch (action.type) {
    case types.FETCH_GROUP_NOMENCLATURES_REQUEST:
      return _.assign({}, state, { isFetching: true, error: false });
    case types.FETCH_GROUP_NOMENCLATURES_ERROR:
      return _.assign({}, state, { isFetching: false, error: true });
    case types.FETCH_GROUP_NOMENCLATURES_SUCCESS:
    ...
    case types.CREATE_GROUP_NOMENCLATURE_REQUEST:
      return _.assign({}, state, {
        isCreating: true,
        error: false,
        errorMessage: ""
      });
    case types.CREATE_GROUP_NOMENCLATURE_ERROR:
      return _.assign({}, state, {
        isCreating: false,
        error: true,
        errorMessage: action.error.response
      });
    case types.CREATE_GROUP_NOMENCLATURE_SUCCESS:
      return _.assign({}, state, {
        entries: state.entries.concat(action.response.body.data),
        isCreating: false
      });

    case types.DELETE_GROUP_NOMENCLATURE_REQUEST:
      return _.assign({}, state, { isDeleting: true, error: false });
    case types.DELETE_GROUP_NOMENCLATURE_ERROR:
      return _.assign({}, state, { isDeleting: false, error: true });
    case types.DELETE_GROUP_NOMENCLATURE_SUCCESS:
    ...
    case types.UPDATE_GROUP_NOMENCLATURE_REQUEST:
      return _.assign({}, state, { isUpdating: true, error: false });
    case types.UPDATE_GROUP_NOMENCLATURE_ERROR:
      return _.assign({}, state, { isUpdating: false, error: true });
    case types.UPDATE_GROUP_NOMENCLATURE_SUCCESS:
      return _.assign({}, state, {
    ...
    case types.FETCH_GROUP_NOMENCLATURE_REQUEST:
      return _.assign({}, state, { isFetching: true, error: false });
    case types.FETCH_GROUP_NOMENCLATURE_ERROR:
      return _.assign({}, state, { isFetching: false, error: true });
    case types.FETCH_GROUP_NOMENCLATURE_SUCCESS:
      return _.assign({}, state, {
        entry: action.response.body.data,
        isFetching: false
      });

    case types.EDIT_GROUP_NOMENCLATURE:
      return _.assign({}, state, {
        entry: _.assign({}, state.entry, { [action.valueType]: action.value })
      });

    case types.RESET_GROUP_NOMENCLATURE_FORM:
      return _.assign({}, state, {
        entry: emptyEntry
      });

    case types.SEARCH_GROUP_NOMENCLATURES:
      return _.assign({}, state, {
